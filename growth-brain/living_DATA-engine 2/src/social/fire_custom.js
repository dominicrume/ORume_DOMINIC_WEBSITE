...
async function fireCustomPost() {
  ...
  console.log('[OpenAI] Generating distinct brand images via ImageAgent for custom post...');
  
  payloadObj.twitter_image_url = await imageAgent.generateImage('twitter', payloadObj.twitter_copy);
  payloadObj.linkedin_personal_image_url = await imageAgent.generateImage('linkedin_personal', payloadObj.linkedin_personal_copy);
  payloadObj.linkedin_company_image_url = await imageAgent.generateImage('linkedin_company', payloadObj.linkedin_company_copy);
  payloadObj.facebook_image_url = await imageAgent.generateImage('facebook', payloadObj.facebook_copy);
  payloadObj.threads_image_url = await imageAgent.generateImage('threads', payloadObj.threads_copy);
